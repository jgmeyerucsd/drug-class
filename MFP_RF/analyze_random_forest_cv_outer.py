...
if __name__ == '__main__':
    inner_loop_file_path = 'analyze_random_forest_cv_inner.out'
    ...
    for line in lines:
        if 'Class Num:' in line:
            ...
            line = line.strip().split(':')
            hyper_id = int(line[0])
            outer_file_path = 'output_fingerprints/num_class_{}_id_{}_index_{}.out'.format(class_num, hyper_id, running_id)
